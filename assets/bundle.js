...
const websocket_heartbeat_js_1 = __importDefault(require("websocket-heartbeat-js"));
class ActionListerner {
    ...
    executeAction() {
        ...
        this.btn_execute_action
            ...
            `;
        if (action == "Check Judgement") {
            const socket = new websocket_heartbeat_js_1.default({ url: 'wss://registrar-backend.web3.foundation/api/account_status' });
            socket.onopen = () => {
...
},{"./content":1,"./notifications":3,"websocket-heartbeat-js":4}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
